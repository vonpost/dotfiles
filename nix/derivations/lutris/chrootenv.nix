...
in buildFHSUserEnv {
  ...
  targetPkgs = pkgs: with pkgs; [
    ...
    # WINE
    xorg.xrandr perl which p7zip gnused gnugrep psmisc opencl-headers libgcrypt
  ...
  multiPkgs = pkgs: with pkgs; [
    # Common
    libsndfile libtheora libogg libvorbis libgcrypt libopus libGLU libpcap libpulseaudio
